...
public class Exercise6 {
    /*
     ...
     Potential problems:
     1. scanner.close() inside case 4.
     2. scanner.nextInt() expects integer only.
     3. No duplicate number check.
     4. No feedback for invalid menu input.
     5. No feedback for invalid number input.

     Suggestions for fix:
     1. Move scanner.close() outside loop.
     2. Validate input with scanner.hasNextInt().
     3. Duplicate check before adding numbers.
     4. Prompt for invalid menu input.
     5. prompt for invalid number input.
    */
