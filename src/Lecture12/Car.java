...
public class Car extends Vehicle implements CarIntirio {
    ...
    public void chipTuning() {
        ...
        // super guarantees that we will use the things that are in the parent class.
        // When we refer to the parent class and use something from the parent class we use the word super.
